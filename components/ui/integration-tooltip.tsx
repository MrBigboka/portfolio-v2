...
export function IntegrationTooltip({ integrations }: IntegrationTooltipProps) {
  const tooltipItems = integrations
    .map((integration, index) => {
      ...
      return {
        id: index,
        name: integration,
        designation: 'Intégration',
        image: integrationData.logo,
      };
    })
    .filter(Boolean) as { id: number; name: string; designation: string; image: string }[];
