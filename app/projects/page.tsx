...
import { ExternalLink, Mail, Users, BarChart3, Database, FileText, MessageSquare, TrendingUp, UserPlus, Headphones, X, CheckCircle2, ChevronLeft, ChevronRight, Tag } from 'lucide-react';
                  ...
                  <div 
                    ...
                    {solution.category === 'App' ? (
                      ...
                      <>
                        ...
                        {/* Integrations positioned at top right */}
                        {solution.integrations && solution.integrations.length > 0 && (
                          <div className="absolute top-4 right-4 z-20">
                            <AvatarStack integrations={solution.integrations} maxDisplay={3} />
                          </div>
                        )}
                        ...
                        <div className="p-5 flex flex-col flex-1">
                          <div className="flex items-start justify-between gap-3 mb-2">
                            ...
                            {solution.tags && solution.tags.length > 0 && (
                              <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 flex-shrink-0">
