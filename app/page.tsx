...
export default function Home() {
  ...
  if (!mounted) {
    return <main className="relative flex flex-col min-h-screen overflow-hidden bg-[var(--theme-primary)] text-white"></main>;
  }
  
  return (
    <PageTransition>
      <main className="relative flex flex-col min-h-screen overflow-hidden bg-white dark:bg-[var(--theme-primary)] text-[var(--theme-primary)] dark:text-[var(--theme-text)] transition-colors duration-300">
        {/* Header Component */}
        <Header />
